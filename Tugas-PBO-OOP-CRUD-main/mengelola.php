      ...
      <div class="container">
        ...
        <form method="POST" action="proses.php" class="font-weight-bold">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nim" class="form-control" id="Nim" placeholder="Contoh: 21051214072" required value="<?php echo $nim; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namamhs" class="form-control" id="Namamhs" placeholder="Contoh: Fitra Nur fauzi" required value="<?php echo $namamhs; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="alamat" class="form-control" id="Alamat" placeholder="Contoh: Jl. las vegas Ponorogo" required value="<?php echo $alamat; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="kota" class="form-control" id="Kota" placeholder="Contoh: Ponorogo" required value="<?php echo $kota; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" class="form-control" id="Email" placeholder="Contoh: reog@gmail.com" required value="<?php echo $email; ?>">
                </div>
            </div>
